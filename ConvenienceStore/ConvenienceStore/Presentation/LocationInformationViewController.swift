...
class LocationInformationViewController: UIViewController, MapControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.view.addSubview(mapContainer!) // mapContainer를 뷰에 추가
